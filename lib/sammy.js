...
(function($, window) {
  ...
  (function(){
    ...
    //      });
    //
    Sammy.Application.prototype.use = function() {
    ...
    //
    Sammy.Application.prototype.bind = function(name, data, callback) {
      var app = this;
      // build the callback
    ...
    Sammy.Application.prototype.trigger = function(name, data) {
      ...
      if(this._listeners[eventName]) {
        $.each(this._listeners[eventName], function(i) {
          this({type: name}, data);
        });
      }
      return this;
    ...
    Sammy.Application.prototype._listen = function(name, callback) {
      var eventName = [this.eventNamespace(), name].join('.');
    ...
    Sammy.Application.prototype._unlisten = function(name, callback) {
      var eventName = [this.eventNamespace(), name].join('.'),
          app = this;;
