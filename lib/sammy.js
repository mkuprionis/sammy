...
(function($, window) {
  ...
  (function(){
    ...
    Sammy.Component.prototype.route = function(verb, path, callback) {
      this.app.registerRoute(verb, path, callback);
      return this;
    };
  ...
  // Sammy.Controller
  (function() {
    Sammy.Controller = function(){};
    Sammy.Controller = Sammy.Component.extend({

    });
  })();
  // end Sammy.Controller
  ...
  (function(){
    ...
    //
    Sammy.Application.prototype.registerRoute = function(verb, path, callback) {
  ...
  (function() {
    ...
    Sammy.EventContext = Sammy.Object.extend({
      ...
      //   the route.
      //
      // @TODO event context must contain component somehow
      //
