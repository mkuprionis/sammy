...
(function($, window) {
  ...
  (function(){
    ...
    Sammy.Component.prototype.after = function(callback) {
      //@TODO mind this - how about these event in compoennt?
      /* make ti like this:
    ...
    // @TODO runRoute:
    //  - move to component
    //  - app has special runRoute which actualy executes route
    //  - component returns callback
    //  - component might delegate execution to child
    //  - maybe provide a callback which is called with content as param after execution?
    //  Actually yeah, because route execution is async
    //
    Sammy.Component.prototype.runRoute = function(verb, path, params, target) {
      ...
      if (componentRoute) {
        ...
        route.callback = function() {
          // @TODO Here smth could be done - component returns DOM, parent handles it.
          // or maybe should simply call parent.swap()
      ...
      if(route) {
        ...
        // @TODO Also should be triggered only once
        ...
        wrapped_route = function() {
          ...
          // @TODO Maybe each component should bind smth like this.bind('event-context-before', function(e) { e.stopPropagation(); });
          // as these events are trigerred in every hierarchy level
  ...
  (function() {
    ...
    Sammy.EventContext.prototype.renderAsync = function() {
      ...
      for(var i=0; i < components.length; i++) {
        ...
        componentContext = new components[i][0].context_prototype(
                                                            components[i][0],
                                                            context.verb,
                                                            context.path,
                                                            context.params,
        ...
        components[i][0][components[i][1]]( componentContext, function() {
          completed++;

          context.partials[components[i][0].name] = componentContext.content;
